...
pub unsafe fn handle_nif_call(function: for<'a> fn(NifEnv<'a>, &[Term<'a>]) -> NifResult<Term<'a>>,
...
pub unsafe fn handle_nif_init_call(function: Option<for<'a> fn(NifEnv<'a>, Term<'a>) -> bool>,
                                   r_env: NIF_ENV,
