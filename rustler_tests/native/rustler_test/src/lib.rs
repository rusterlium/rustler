...
rustler::init!(
    ...
    [
        ...
        test_codegen::struct_lifetime_echo,
        test_codegen::tuple_lifetime_echo,
        test_codegen::record_lifetime_echo,
        test_codegen::map_lifetime_echo,
        test_codegen::untagged_enum_lifetime_echo,
        test_codegen::tuplestruct_lifetime_echo,
