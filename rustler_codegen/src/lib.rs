...
easy_plugin! {
    ...
    pub fn export_nifs_macro(context: &mut ExtCtxt, _span: Span, arguments: Arguments) -> PluginResult<Box<MacResult>> {
...
pub fn plugin_registrar(reg: &mut Registry) {
    reg.register_macro("rustler_export_nifs", export_nifs_macro);
}
