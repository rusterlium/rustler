...
pub fn resource_make<'a>(env: NifEnv<'a>, _args: &[Term<'a>]) -> NifResult<Term<'a>> {
...
pub fn resource_set_integer_field<'a>(env: NifEnv<'a>, args: &[Term<'a>]) -> NifResult<Term<'a>> {
...
pub fn resource_get_integer_field<'a>(env: NifEnv<'a>, args: &[Term<'a>]) ->  NifResult<Term<'a>> {
    let resource: ResourceArc<TestResource> = try!(args[0].decode());
...
pub fn resource_make_immutable<'a>(env: NifEnv<'a>, args: &[Term<'a>]) -> NifResult<Term<'a>> {
...
pub fn resource_immutable_count<'a>(env: NifEnv<'a>, _args: &[Term<'a>]) -> NifResult<Term<'a>> {
