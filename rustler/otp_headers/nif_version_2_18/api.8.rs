...
pub struct DynNifCallbacks {
    ...
    enif_get_string_length: Option<extern "C" fn (env: *mut ErlNifEnv, list: ERL_NIF_TERM, len: *mut c_uint, encoding: ErlNifCharEncoding) -> c_int>,
    enif_make_new_atom: Option<extern "C" fn (env: *mut ErlNifEnv, name: *const c_char, atom: *mut ERL_NIF_TERM, encoding: ErlNifCharEncoding) -> c_int>,
    enif_make_new_atom_len: Option<extern "C" fn (env: *mut ErlNifEnv, name: *const c_char, len: size_t, atom: *mut ERL_NIF_TERM, encoding: ErlNifCharEncoding) -> c_int>,
    enif_set_option: Option<extern "C" fn (env: *mut ErlNifEnv, opt: ErlNifOption, ...) -> c_int>,
    enif_term_size: Option<extern "C" fn (term: ERL_NIF_TERM) -> size_t>,
    enif_get_atom_cache_index: Option<extern "C" fn (env: *mut ErlNifEnv, atom: ERL_NIF_TERM, index: *mut c_uint) -> c_int>,
    enif_max_atom_cache_index: Option<extern "C" fn () -> c_uint>,
}
...
/// See [enif_get_string_length](http://www.erlang.org/doc/man/erl_nif.html#enif_get_string_length) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_get_string_length(env: *mut ErlNifEnv, list: ERL_NIF_TERM, len: *mut c_uint, encoding: ErlNifCharEncoding)
 -> c_int{
    (DYN_NIF_CALLBACKS.enif_get_string_length.unwrap_unchecked())(env, list, len, encoding)
}

/// See [enif_make_new_atom](http://www.erlang.org/doc/man/erl_nif.html#enif_make_new_atom) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_make_new_atom(env: *mut ErlNifEnv, name: *const c_char, atom: *mut ERL_NIF_TERM, encoding: ErlNifCharEncoding)
 -> c_int{
    (DYN_NIF_CALLBACKS.enif_make_new_atom.unwrap_unchecked())(env, name, atom, encoding)
}

/// See [enif_make_new_atom_len](http://www.erlang.org/doc/man/erl_nif.html#enif_make_new_atom_len) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_make_new_atom_len(env: *mut ErlNifEnv, name: *const c_char, len: size_t, atom: *mut ERL_NIF_TERM, encoding: ErlNifCharEncoding)
 -> c_int{
...
/// See [enif_term_size](http://www.erlang.org/doc/man/erl_nif.html#enif_term_size) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_term_size(term: ERL_NIF_TERM)
 -> size_t{
    (DYN_NIF_CALLBACKS.enif_term_size.unwrap_unchecked())(term)
}

/// See [enif_get_atom_cache_index](http://www.erlang.org/doc/man/erl_nif.html#enif_get_atom_cache_index) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_get_atom_cache_index(env: *mut ErlNifEnv, atom: ERL_NIF_TERM, index: *mut c_uint)
 -> c_int{
    (DYN_NIF_CALLBACKS.enif_get_atom_cache_index.unwrap_unchecked())(env, atom, index)
}

/// See [enif_max_atom_cache_index](http://www.erlang.org/doc/man/erl_nif.html#enif_max_atom_cache_index) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_max_atom_cache_index()
 -> c_uint{
...
impl DynNifCallbacks {
    fn write_symbols<T: DynNifFiller>(&mut self, filler: T) {
        ...
        filler.write(&mut self.enif_get_string_length, "enif_get_string_length ");
        filler.write(&mut self.enif_make_new_atom, "enif_make_new_atom ");
        filler.write(&mut self.enif_make_new_atom_len, "enif_make_new_atom_len ");
        filler.write(&mut self.enif_set_option, "enif_set_option ");
        filler.write(&mut self.enif_term_size, "enif_term_size ");
        filler.write(&mut self.enif_get_atom_cache_index, "enif_get_atom_cache_index ");
        filler.write(&mut self.enif_max_atom_cache_index, "enif_max_atom_cache_index ");
    }
}
