...
//! Currently we are using erl_nif_sys, but we do want to be able to easily
//! switch to something else in the future if required.
//!
//! While reexporting from erl_nif_sys directly would remove a lot of code, it
...
pub type NIF_PID = *const erl_nif_sys::ErlNifPid;
...
pub unsafe fn enif_make_existing_atom_len(
    ...
    erl_nif_sys::enif_make_existing_atom_len(
        env,
        string,
        length,
        atom_out,
        erl_nif_sys::ErlNifCharEncoding::ERL_NIF_LATIN1,
    )
}
...
pub unsafe fn enif_get_atom_length_latin1(env: NIF_ENV, term: NIF_TERM, len: *mut c_uint) -> c_int {
    erl_nif_sys::enif_get_atom_length(
        env,
        term,
        len,
        erl_nif_sys::ErlNifCharEncoding::ERL_NIF_LATIN1,
...
pub unsafe fn enif_make_sub_binary(
    ...
    erl_nif_sys::enif_make_sub_binary(env, bin_term, pos, size)
}
...
pub unsafe fn enif_get_map_value(
    ...
    erl_nif_sys::enif_get_map_value(env, map, key, value)
}
pub unsafe fn enif_get_map_size(env: NIF_ENV, map: NIF_TERM, size: *mut size_t) -> c_int {
    erl_nif_sys::enif_get_map_size(env, map, size)
}
...
pub unsafe fn enif_make_map_put(
    ...
    erl_nif_sys::enif_make_map_put(env, map_in, key, value, map_out)
}
pub unsafe fn enif_make_map_update(
    ...
    erl_nif_sys::enif_make_map_update(env, map_in, key, value, map_out)
}
pub unsafe fn enif_make_map_remove(
    ...
    erl_nif_sys::enif_make_map_remove(env, map_in, key, map_out)
}
...
pub unsafe fn enif_make_map_from_arrays(
    ...
    erl_nif_sys::enif_make_map_from_arrays(env, keys, value, cnt, map_out)
}
...
pub unsafe fn enif_get_tuple(
    ...
    erl_nif_sys::enif_get_tuple(env, term, arity, array)
}
pub unsafe fn enif_make_tuple_from_array(
    ...
    erl_nif_sys::enif_make_tuple_from_array(env, terms, terms_len)
}
...
pub unsafe fn enif_get_list_cell(
    ...
    erl_nif_sys::enif_get_list_cell(env, list, head, tail)
}
pub unsafe fn enif_get_list_length(env: NIF_ENV, list: NIF_TERM, length: *mut c_uint) -> c_int {
    erl_nif_sys::enif_get_list_length(env, list, length)
}
pub unsafe fn enif_make_list_from_array(
    ...
    erl_nif_sys::enif_make_list_from_array(env, arr, cnt)
}
pub unsafe fn enif_make_list_cell(env: NIF_ENV, head: NIF_TERM, tail: NIF_TERM) -> NIF_TERM {
    erl_nif_sys::enif_make_list_cell(env, head, tail)
}
pub unsafe fn enif_make_reverse_list(
    ...
    erl_nif_sys::enif_make_reverse_list(env, list_in, list_out)
}
...
pub unsafe fn enif_get_resource(
    ...
    erl_nif_sys::enif_get_resource(env, term, typ, objp)
}
pub unsafe fn enif_release_resource(obj: NIF_RESOURCE_HANDLE) {
    erl_nif_sys::enif_release_resource(obj)
}
pub unsafe fn enif_keep_resource(obj: NIF_RESOURCE_HANDLE) {
    erl_nif_sys::enif_keep_resource(obj)
}
...
pub unsafe fn enif_consume_timeslice(env: NIF_ENV, percent: c_int) -> c_int {
    erl_nif_sys::enif_consume_timeslice(env, percent)
}
...
pub unsafe fn enif_schedule_nif(
    ...
    erl_nif_sys::enif_schedule_nif(env, fun_name, flags, fp, argc, argv)
}

// Processes
pub unsafe fn enif_send(env: NIF_ENV, to_pid: NIF_PID, msg_env: NIF_ENV, msg: NIF_TERM) -> c_int {
    erl_nif_sys::enif_send(env, to_pid, msg_env, msg)
}
...
pub fn enif_thread_type() -> c_int {
    ...
    unsafe { erl_nif_sys::enif_thread_type() }
}
