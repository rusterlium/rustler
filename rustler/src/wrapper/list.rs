...
#[inline]
pub unsafe fn get_list_length(env: *mut ErlNifEnv, list: ErlNifTerm) -> Option<usize> {
    let mut len: u32 = 0;
...
#[inline]
pub unsafe fn make_list(env: *mut ErlNifEnv, arr: &[ErlNifTerm]) -> ErlNifTerm {
...
#[inline]
pub unsafe fn make_reverse_list(env: *mut ErlNifEnv, list: ErlNifTerm) -> Option<ErlNifTerm> {
